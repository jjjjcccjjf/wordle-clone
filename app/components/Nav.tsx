...
export default function Nav({ children }: NavProps) {
  return (
    <nav className="md:h-[66px] h-[41px] fixed top-0 left-0 w-full grid items-center border-b border-b-miss bg-wordle-bg">
      <ul className="grid grid-flow-col grid-cols-3  items-center">
        ...
        <li className="md:place-self-center place-self-end flex items-center justify-center md:flex-col flex-row md:gap-0">
                  <p className="font-patua-one text-white md:text-4xl text-2xl">Wordle</p>
